 ...
 * must have run memfd_shmem_set_size(fd, ...) first.
 */
...
/*
 * Sequential wrapper kept for back-compat callers: structural half followed
 * by content half. Returns 0 on success, 1 on failure (matching the original
 * caller convention).
 */
